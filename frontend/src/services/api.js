...
class ApiClient {
  ...
  triggerETL() { return this.post("/admin/etl/run", {}); }
    ...
    cifradoDropPlaintext(mode = "dry-run", confirm = "") { return this.post(`/admin/cifrado/drop-plaintext?mode=${encodeURIComponent(mode)}&confirm=${encodeURIComponent(confirm)}`, {}); }
